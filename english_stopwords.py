"""Standard English stop words, vendored from scikit-learn 1.x
(sklearn.feature_extraction.text.ENGLISH_STOP_WORDS — BSD-3-Clause,
originally the Glasgow Information Retrieval Group list).

Vendored so the engine has no scikit-learn dependency: the only thing we
used from it was this frozenset, and dropping the dependency keeps the
serverless (Vercel) bundle far under the size limit."""
